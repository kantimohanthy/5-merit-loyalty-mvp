  ...
  return (
    <div className="min-h-screen bg-paper pb-16">
      <header className="border-b border-line bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-display text-lg text-ink">Merit Network</span>
          </div>
      ...
      <main className="mx-auto max-w-6xl px-6 py-10">
        <SectionLabel>Ecosystem Architecture &amp; Network Story</SectionLabel>
        ...
        <p className="mt-3 max-w-2xl text-navy-600">
          The behavioral engine runs inside &mdash; or directly adjacent to &mdash; each
            ...
            <div className="flex-1 rounded-xl2 border-2 border-dashed border-navy-500/30 bg-white p-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold uppercase tracking-[0.14em] text-navy-800">
                  Participating bank &mdash; controlled infrastructure
                </span>
              </div>
              ...
              <div className="mt-3 flex items-center gap-2 rounded-lg bg-positive-50 px-3 py-2 text-xs font-medium text-positive-600">
                <Lock size={13} />
                Minimal verified behavioral output only &mdash; not raw transactions
              </div>
            </div>
        ...
        <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <Card className="flex items-start gap-3 p-5">
            ...
            <p className="text-sm text-navy-600">
              ...
              G-Core defines the common status standard, earning rules, and tier definitions across participating banks &mdash; but banks keep full control of their own products, pricing, and lending decisions.
            </p>
          </Card>
        </div>
          ...
          <div className="mt-6 grid grid-cols-1 items-stretch gap-3 lg:grid-cols-[1fr_auto_1fr_auto_1fr]">
            <Card className="p-5">
              ...
              <p className="mt-1 text-sm text-navy-600">
                Better financial habits + personally relevant rewards &rarr;
                higher engagement.
              </p>
            </Card>
            ...
            <Card className="p-5">
              ...
              <p className="mt-1 text-sm text-navy-600">
                Higher retention + lifetime value &rarr; a better reward
                ecosystem.
              </p>
            </Card>
            <div className="hidden items-center justify-center text-navy-300 lg:flex">
            ...
            <Card className="p-5">
              ...
              <p className="mt-1 text-sm text-navy-600">
                Higher-intent customers + relevant campaigns &rarr; better offers,
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-2 max-w-xl text-sm text-navy-600">
                ...
                institutions join &mdash; but it stands on its own for the first
                bank.
              </p>
            </div>
        ...
        <div className="mt-8 text-center text-xs text-navy-400">
          <Link href="/demo" className="inline-flex items-center gap-1.5 text-navy-600 hover:text-navy-900 underline">
            <Brain size={13} /> Open Demo 1 Walkthrough (Behavioral Intelligence)
          </Link>
        </div>
      </main>
    </div>
