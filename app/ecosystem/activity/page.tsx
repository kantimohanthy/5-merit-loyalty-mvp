...
export default function EcosystemActivityPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <SectionLabel>Behavioral Transaction Analysis</SectionLabel>
          <h1 className="mt-2 font-display text-3xl text-ink">
            Behavioral Activity
          </h1>
          <p className="mt-2 max-w-xl text-xs text-navy-600">
            Every transaction is classified automatically with a confidence score. Tap any transaction to inspect its classification reasoning, protected status, or anti-gaming rules.
          </p>
        </div>
        <div className="flex flex-wrap items-center gap-2">
          <button
            onClick={simulateEmergency}
            className="flex items-center gap-2 rounded-full border border-line bg-white px-4 py-2 text-xs font-semibold text-navy-800 hover:border-navy-500/40 shadow-xs"
          >
            <Sparkles size={14} />
